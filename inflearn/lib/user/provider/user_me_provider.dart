...
import 'package:inflearn/user/repository/auth_repository.dart';
...
class UserMeStateNotifier  extends StateNotifier<UserModelBase?>{
  ...
  Future<UserModelBase> login({
    ...
    try{
      ...
      await storage.write(key: ACCESS_TOKEN_KEY, value: resp.acessToken);
      ...
      state = UserModelError(message: '로그인을 실패했습니다');
